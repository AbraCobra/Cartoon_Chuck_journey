...
int main()
    ...
    HDC  background_Cartoon = txLoadImage ("PICEXAMPLE//COMMONPIC.bmp");
    ...
    while (t <= 250)
        ...
        Skate_wheels_draw   (-  50 + 8*t + ROUND (4*cos(t)) + ROUND (3*sin(t)), (550 - 3*t) + ROUND (3*cos(t)) - ROUND (4*sin(t)), 20);
        ...
        Butterfly_draw      (  120 + 15*(t - sin(t)), 500 + 50*(1 - cos(t)), RGB (100,  39,  51), 2);
        Butterfly_draw      (  100 + 15*(t - sin(t)), 500 + 20*(1 - cos(t)), RGB (245, 100,   0), 3);

        Deffy               (  450, 700 - t*3, 0.6, 0.6, abs(t%swing - swing/2) - swing/4, abs(t%twitch - twitch/2) - twitch/4, RGB (217, 0, 217),
